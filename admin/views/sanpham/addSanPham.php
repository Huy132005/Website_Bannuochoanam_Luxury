              ...
              <form action="<?= BASE_URL_ADMIN . '?act=them-san-pham' ?>" method="POST" enctype="multipart/form-data"  >
                <div class="card-body row">
                  <div class="form-group col-12">
                    ...
                    <input type="text" class="form-control" name="ten_san_pham" placeholder=" Nhập tên sản phẩm">
                  ...
                  <div class="form-group col-6">
                    ...
                    <input type="date" class="form-control" name="ngay_nhap" placeholder=" Nhập ngày sản phẩm">
...
<textarea name="mo_ta" id="" class="form-control" placeholder=" Nhập mô tả"></textarea>
                  ...
                  <div class="form-group col-6">
                    ...
                    <select class="form-control" name="dung_tich" id="exampleFormControlSelect1" >
                      <option >Chọn dung tích  sản phẩm</option>
                      <option value="1">10ml</option>
                      <option value="2">20ml</option>
                      <option value="3">50ml</option>
                      <option value="4">100ml</option>
                    </select>
                    <?php if(isset($_SESSION['error']['dung_tich'])) {?>
                    <p class="text-danger"><?= $_SESSION['error']['dung_tich'] ?></p>
                  <?php  } ?>
                  </div>
