           ...
           <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <a href="<?= BASE_URL_ADMIN . '?act=from-sua-don-hang&id_don_hang=' . $donHang['id'] ?>"><button class="btn btn-warning"><i class="fas fa-cog"></i></button></a>
          ...
          <div class="col-12">
           ...
           <table id="example2" class="table table-bordered table-striped">
                  ...
                  <tr>
                   ...
                   <button onclick="return confirm('Bạn có muốn ẩn bình luận này không ?')" class="btn btn-danger">
