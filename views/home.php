        ...
        <section class="slider-area">
            <div class="hero-slider-active slick-arrow-style slick-arrow-style_hero slick-dot-style">
                ...
                <div class="hero-single-slide hero-overlay">
                    <div class="hero-slider-item bg-img" data-bg="assets/img/slider/slider1.11.png">
                        <div class="container">
                            <div class="row">
                ...
                <div class="hero-single-slide hero-overlay">
                    <div class="hero-slider-item bg-img" data-bg="assets/img/slider/slider2.11.jpg">
                        <div class="container">
                            <div class="row">
                ...
                <div class="hero-single-slide hero-overlay">
                    <div class="hero-slider-item bg-img" data-bg="assets/img/slider/slider3.11.png">
                        <div class="container">
                            <div class="row">
        ...
        <div class="banner-statistics-area">
            <div class="container">
                <div class="row row-20 mtn-20">
                    <div class="col-sm-3">
                        <figure class="banner-statistics mt-15">
                            <a href="#">
                                <img style="width:400px ;height:200px;" src="assets/img/slider/1.jpg" alt="product banner">
                            </a>
                    ...
                    <div class="col-sm-3">
                        <figure class="banner-statistics mt-15">
                            <a href="#">
                                <img  style="width:400px ;height:200px;" src="assets/img/slider/2.jpg" alt="product banner">
                            </a>
                    ...
                    <div class="col-sm-3">
                        <figure class="banner-statistics mt-15">
                            <a href="#">
                                <img  style="width:400px ;height:200px;" src="assets/img/slider/3.jpg" alt="product banner">
                            </a>
                            <div class="banner-content text-center">
                    ...
                    <div class="col-sm-3">
                        <figure class="banner-statistics mt-15">
                            <a href="#">
                                <img  style="width:400px ;height:200px;" src="assets/img/slider/4.jpg" alt="product banner">
                            </a>
                            <div class="banner-content text-right">
                ...
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="section-title text-center">
                            <h2 class="title">Sản Phẩm Chúng Tôi</h2>
                            <p class="sub-title">Sản phẩm cập nhật liêm tục</p>
                        </div>
                        <!-- section title start -->
                    </div>
                </div>
                        ...
                        <div class="product-banner-carousel slick-row-10">
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/slider/d.jpg" alt="product banner" height="390px">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                                        <h5 class="banner-text3"><a href="#">Dior</a></h5>
                                    </div>
                                </figure>
                            </div>
                            <!-- banner single slide start -->
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/slider/v.jpg" alt="product banner" height="390px">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                                        <h5 class="banner-text3"><a href="#">Versace</a></h5>
                                    </div>
                                </figure>
                            </div>
                            <!-- banner single slide start -->
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/slider/j.jpg" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                                        <h5 class="banner-text3"><a href="#"> Jean paul</a></h5>
                                    </div>
                                </figure>
                            </div>
                            <!-- banner single slide start -->
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/slider/b.jpg" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                                        <h5 class="banner-text3"><a href="#">Burberry</a></h5>
                                    </div>
                                </figure>
                            </div>
                            <!-- banner single slide start -->
                            ...
                            <div class="banner-slide-item">
                                <figure class="banner-statistics">
                                    <a href="#">
                                        <img src="assets/img/slider/g.jpg" alt="product banner">
                                    </a>
                                    <div class="banner-content banner-content_style2">
                                        <h5 class="banner-text3"><a href="#"> Gucci</a></h5>
                                    </div>
                                </figure>
                            </div>
                            <!-- banner single slide start -->
