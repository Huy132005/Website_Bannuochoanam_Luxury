                        ...
                        <div class="widget-item">
                            <div class="widget-title">
                                <div class="widget-logo">
                                    <a href="index.html">
                                        <img src="assets/img/logo/logo2.jpg" alt="brand logo" width="100px">
                                    </a>
                                </div>
                            </div>
                            <div class="widget-body">
                                <p>Ở đây có các loại nước hoa nam cao cấp </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        ...
                                        <li><i class="pe-7s-mail"></i> <a href="mailto:demo@plazathemes.com">tungntph48782@gmail.com </a></li>
                                        <li><i class="pe-7s-call"></i> <a href="tel:(012)800456789987">0366311890</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="copyright-text text-center">
                            <p>&copy; 2024 <b>tungntph48782</b> @gmail.com <i class="fa fa-heart text-danger"></i> by <a href="https://hasthemes.com/"><b>FPT</b></a></p>
                        </div>
                    </div>
                </div>
            </div>
